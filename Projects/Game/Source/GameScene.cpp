...
void GameScene::init()
{
	...
	//
	//// camera
	//lg::Camera* camera = createCamera(1, lg::Engine::getInstance().getWindowByIndex(0)->getSize(), vec3(0.0f, 0.0f, 7.0f));
	...
	//	{
	//		lg::Sprite* sprite = createSprite(++sprite_id, sprite_mesh, sprite_material_2, vec2(512.0f, 256.0f));
	//
