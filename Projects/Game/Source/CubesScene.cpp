...
void CubesScene::init()
{
	...
	lg::Texture* plane_texture = lg::Resources::getInstance().createTexture(lg::Resources::getNextAvailableId(), "floor.texture");
	...
	//lg::Sprite* sprite = createSprite(6, sprite_mesh, sprite_material);
